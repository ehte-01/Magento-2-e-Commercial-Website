...
Stripe supports manual capture for some payment method types. You can configure this behaviour in the application settings page by setting the `Payment Action` property of an eligible payment method to **Authorise Only**.
